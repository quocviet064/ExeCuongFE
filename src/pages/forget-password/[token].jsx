  ...
  const onSubmit = (data) => {
    confirmForgotPassword({
      ...
      if (result?.error) {
        ...
        notifyError("Lỗi: " + result?.error?.data?.error);
      } else {
        // notifySuccess(result?.data?.message);
        notifySuccess("Thành công: " + result?.data?.message);

        //Todo:thay notifySuccess bằng loadingPage

        //Todo: Gửi email xác nhận mật khẩu đã thay đổi
        //sendConfirmationEmail();

        //Todo: Đăng xuất tất cả các phiên
